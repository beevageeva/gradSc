  ...
  ! initialize one grid 
    ...
    select case(iprob)
     case(1)
       ...
       pert(ixO^S) = 0d0
       do nn=1,NModes
        pert(ixO^S) =  pert(ixO^S) +  sin(2*dpi*(x(ixO^S,1)-xprobmin1)*nn/(xprobmax1-xprobmin1))
       enddo
        pert(ixO^S) =  pert(ixO^S)/NModes
!       k1=6.d0*dpi
!       k2=12.d0*dpi
!       k3=18.d0*dpi
!       k4=24.d0*dpi
...
!       k16=96.d0*dpi 
       ...
       !w(ixO^S,mom(2))=dv*(sin(k1*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k2*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k3*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k4*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k5*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k6*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k7*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k8*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k9*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k10*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k11*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k12*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k13*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k14*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k15*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1))+sin(k16*(x(ixO^S,1)-xprobmin1)/(xprobmax1-xprobmin1)))*&
       !             exp(-((x(ixO^S,2)-(xprobmax2+xprobmin2)/two)/sigma)**2)

       w(ixO^S,mom(2))=dv* pert(ixO^S)*&
                    exp(-((x(ixO^S,2)-(xprobmax2+xprobmin2)/two)/sigma)**2)
